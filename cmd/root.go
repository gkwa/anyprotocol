...
import (
	...
	"github.com/gkwa/anyprotocol/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.anyprotocol.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".anyprotocol")
	}
